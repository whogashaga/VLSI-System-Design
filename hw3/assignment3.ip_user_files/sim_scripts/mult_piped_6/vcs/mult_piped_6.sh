...
#                script (type 'mult_piped_6.sh -help' for more information).
#
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.mult_piped_6 -o mult_piped_6_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./mult_piped_6_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key mult_piped_6_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc mult_piped_6_simv.daidir vcs_lib c.obj)
