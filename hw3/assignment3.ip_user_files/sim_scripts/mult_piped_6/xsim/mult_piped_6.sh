...
#
# Script generated by Vivado on Fri Apr 19 14:24:22 -0700 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : mult_piped_6.sh
...
#
# Usage        : mult_piped_6.sh
#                mult_piped_6.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mult_piped_6.sh [-reset_run]
#                mult_piped_6.sh [-reset_log]
#                mult_piped_6.sh [-help]
#
...
# script info
echo -e "mult_piped_6.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mult_piped_6.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_11 -L xbip_pipe_v3_0_7 -L xbip_bram18k_v3_0_7 -L mult_gen_v12_0_19 -L xil_defaultlib -L secureip -L xpm --snapshot mult_piped_6 xil_defaultlib.mult_piped_6 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mult_piped_6 -key {Behavioral:sim_1:Functional:mult_piped_6} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mult_piped_6.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mult_piped_6.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mult_piped_6.sh [-help]\n\
Usage: mult_piped_6.sh [-step]\n\
Usage: mult_piped_6.sh [-lib_map_path]\n\
Usage: mult_piped_6.sh [-reset_run]\n\
Usage: mult_piped_6.sh [-reset_log]\n\
Usage: mult_piped_6.sh [-keep_index]\n\
Usage: mult_piped_6.sh [-noclean_files]\n\n\
