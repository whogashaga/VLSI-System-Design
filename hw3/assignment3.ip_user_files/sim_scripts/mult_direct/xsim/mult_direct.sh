...
#
# Script generated by Vivado on Thu Apr 25 15:49:12 -0700 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : mult_direct.sh
...
#
# Usage        : mult_direct.sh
#                mult_direct.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mult_direct.sh [-reset_run]
#                mult_direct.sh [-reset_log]
#                mult_direct.sh [-help]
#
...
# script info
echo -e "mult_direct.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mult_direct.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_11 -L xbip_pipe_v3_0_7 -L xbip_bram18k_v3_0_7 -L mult_gen_v12_0_19 -L xil_defaultlib -L secureip -L xpm --snapshot mult_direct xil_defaultlib.mult_direct -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mult_direct -key {Behavioral:sim_1:Functional:mult_direct} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mult_direct.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mult_direct.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mult_direct.sh [-help]\n\
Usage: mult_direct.sh [-step]\n\
Usage: mult_direct.sh [-lib_map_path]\n\
Usage: mult_direct.sh [-reset_run]\n\
Usage: mult_direct.sh [-reset_log]\n\
Usage: mult_direct.sh [-keep_index]\n\
Usage: mult_direct.sh [-noclean_files]\n\n\
