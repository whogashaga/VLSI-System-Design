...
#
# Script generated by Vivado on Mon May 20 10:31:53 -0700 2024
...
#
# Usage        : mult_32.sh
#                mult_32.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mult_32.sh [-reset_run]
#                mult_32.sh [-reset_log]
#                mult_32.sh [-help]
#
...
# script info
echo -e "mult_32.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mult_32.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_utils_v3_0_11 -L xbip_pipe_v3_0_7 -L xbip_bram18k_v3_0_7 -L mult_gen_v12_0_19 -L xil_defaultlib -L secureip -L xpm --snapshot mult_32 xil_defaultlib.mult_32 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mult_32 -key {Behavioral:sim_1:Functional:mult_32} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mult_32.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mult_32.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mult_32.sh [-help]\n\
Usage: mult_32.sh [-step]\n\
Usage: mult_32.sh [-lib_map_path]\n\
Usage: mult_32.sh [-reset_run]\n\
Usage: mult_32.sh [-reset_log]\n\
Usage: mult_32.sh [-keep_index]\n\
Usage: mult_32.sh [-noclean_files]\n\n\
