...
#
# Script generated by Vivado on Thu May 02 13:55:11 -0700 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fixedKeySchedule.sh
...
#
# Usage        : fixedKeySchedule.sh
#                fixedKeySchedule.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fixedKeySchedule.sh [-reset_run]
#                fixedKeySchedule.sh [-reset_log]
#                fixedKeySchedule.sh [-help]
#
...
#                script (type 'fixedKeySchedule.sh -help' for more information).
#
...
# script info
echo -e "fixedKeySchedule.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fixedKeySchedule.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.fixedKeySchedule xil_defaultlib.glbl -o fixedKeySchedule_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./fixedKeySchedule_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key fixedKeySchedule_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fixedKeySchedule_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fixedKeySchedule.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fixedKeySchedule.sh [-help]\n\
Usage: fixedKeySchedule.sh [-step]\n\
Usage: fixedKeySchedule.sh [-lib_map_path]\n\
Usage: fixedKeySchedule.sh [-reset_run]\n\
Usage: fixedKeySchedule.sh [-reset_log]\n\
Usage: fixedKeySchedule.sh [-keep_index]\n\
Usage: fixedKeySchedule.sh [-noclean_files]\n\n\
