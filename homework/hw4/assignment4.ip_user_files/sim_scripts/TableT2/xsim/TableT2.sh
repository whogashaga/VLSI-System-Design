...
#
# Script generated by Vivado on Thu May 02 14:00:17 -0700 2024
...
#
# Usage        : TableT2.sh
#                TableT2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                TableT2.sh [-reset_run]
#                TableT2.sh [-reset_log]
#                TableT2.sh [-help]
#
...
# script info
echo -e "TableT2.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./TableT2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_7 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot TableT2 xil_defaultlib.TableT2 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim TableT2 -key {Behavioral:sim_1:Functional:TableT2} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb TableT2.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./TableT2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: TableT2.sh [-help]\n\
Usage: TableT2.sh [-step]\n\
Usage: TableT2.sh [-lib_map_path]\n\
Usage: TableT2.sh [-reset_run]\n\
Usage: TableT2.sh [-reset_log]\n\
Usage: TableT2.sh [-keep_index]\n\
Usage: TableT2.sh [-noclean_files]\n\n\
