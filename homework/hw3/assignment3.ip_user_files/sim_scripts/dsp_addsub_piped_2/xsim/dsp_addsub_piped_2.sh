...
#
# Script generated by Vivado on Mon Apr 29 23:10:04 -0700 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : dsp_addsub_piped_2.sh
...
#
# Usage        : dsp_addsub_piped_2.sh
#                dsp_addsub_piped_2.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                dsp_addsub_piped_2.sh [-reset_run]
#                dsp_addsub_piped_2.sh [-reset_log]
#                dsp_addsub_piped_2.sh [-help]
#
...
# script info
echo -e "dsp_addsub_piped_2.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./dsp_addsub_piped_2.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xbip_dsp48_wrapper_v3_0_5 -L xbip_utils_v3_0_11 -L xbip_pipe_v3_0_7 -L dsp_macro_v1_0_4 -L xil_defaultlib -L secureip -L xpm --snapshot dsp_addsub_piped_2 xil_defaultlib.dsp_addsub_piped_2 -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim dsp_addsub_piped_2 -key {Behavioral:sim_1:Functional:dsp_addsub_piped_2} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb dsp_addsub_piped_2.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./dsp_addsub_piped_2.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: dsp_addsub_piped_2.sh [-help]\n\
Usage: dsp_addsub_piped_2.sh [-step]\n\
Usage: dsp_addsub_piped_2.sh [-lib_map_path]\n\
Usage: dsp_addsub_piped_2.sh [-reset_run]\n\
Usage: dsp_addsub_piped_2.sh [-reset_log]\n\
Usage: dsp_addsub_piped_2.sh [-keep_index]\n\
Usage: dsp_addsub_piped_2.sh [-noclean_files]\n\n\
