...
#
# Script generated by Vivado on Thu May 30 09:31:59 -0700 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : bram_jumpx.sh
...
#
# Usage        : bram_jumpx.sh
#                bram_jumpx.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bram_jumpx.sh [-reset_run]
#                bram_jumpx.sh [-reset_log]
#                bram_jumpx.sh [-help]
#
...
#                script (type 'bram_jumpx.sh -help' for more information).
#
...
# script info
echo -e "bram_jumpx.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bram_jumpx.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.bram_jumpx xil_defaultlib.glbl -o bram_jumpx_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./bram_jumpx_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key bram_jumpx_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc bram_jumpx_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bram_jumpx.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bram_jumpx.sh [-help]\n\
Usage: bram_jumpx.sh [-step]\n\
Usage: bram_jumpx.sh [-lib_map_path]\n\
Usage: bram_jumpx.sh [-reset_run]\n\
Usage: bram_jumpx.sh [-reset_log]\n\
Usage: bram_jumpx.sh [-keep_index]\n\
Usage: bram_jumpx.sh [-noclean_files]\n\n\
