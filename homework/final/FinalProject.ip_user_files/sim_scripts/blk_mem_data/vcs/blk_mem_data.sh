...
#
# Script generated by Vivado on Fri Jun 07 10:56:54 -0700 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : blk_mem_data.sh
...
#
# Usage        : blk_mem_data.sh
#                blk_mem_data.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                blk_mem_data.sh [-reset_run]
#                blk_mem_data.sh [-reset_log]
#                blk_mem_data.sh [-help]
#
...
#                script (type 'blk_mem_data.sh -help' for more information).
#
...
# script info
echo -e "blk_mem_data.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./blk_mem_data.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.blk_mem_data xil_defaultlib.glbl -o blk_mem_data_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./blk_mem_data_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key blk_mem_data_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc blk_mem_data_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./blk_mem_data.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: blk_mem_data.sh [-help]\n\
Usage: blk_mem_data.sh [-step]\n\
Usage: blk_mem_data.sh [-lib_map_path]\n\
Usage: blk_mem_data.sh [-reset_run]\n\
Usage: blk_mem_data.sh [-reset_log]\n\
Usage: blk_mem_data.sh [-keep_index]\n\
Usage: blk_mem_data.sh [-noclean_files]\n\n\
