...
HD_PWD='C:/Users/coe_user/Documents/ECE574_Local/homework/final/FinalProject.runs/blk_mem_program_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_program.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_program.tcl
